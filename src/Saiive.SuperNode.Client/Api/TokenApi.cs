...
namespace Saiive.SuperNode.Client.Api
{
    ...
    public class TokenApi : ITokenApi
    {
        ...
        public Dictionary<string, TokenModel> ApiV1NetworkCoinTokensGet (string coin, string network)
        {
            ...
            if (coin == null) throw new ApiException(400, "Missing required parameter 'coin' when calling ApiV1NetworkCoinTokensGet");
            // verify the required parameter 'network' is set
            if (network == null) throw new ApiException(400, "Missing required parameter 'network' when calling ApiV1NetworkCoinTokensGet");
...
path = path.Replace("{" + "network" + "}", ApiClient.ParameterToString(network));
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiV1NetworkCoinTokensGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiV1NetworkCoinTokensGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        {
            // verify the required parameter 'coin' is set
            if (coin == null) throw new ApiException(400, "Missing required parameter 'coin' when calling ApiV1NetworkCoinTokensTokenGet");
            // verify the required parameter 'network' is set
            if (network == null) throw new ApiException(400, "Missing required parameter 'network' when calling ApiV1NetworkCoinTokensTokenGet");
            // verify the required parameter 'token' is set
            if (token == null) throw new ApiException(400, "Missing required parameter 'token' when calling ApiV1NetworkCoinTokensTokenGet");
...
path = path.Replace("{" + "token" + "}", ApiClient.ParameterToString(token));
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiV1NetworkCoinTokensTokenGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApiV1NetworkCoinTokensTokenGet: " + response.ErrorMessage, response.ErrorMessage);
